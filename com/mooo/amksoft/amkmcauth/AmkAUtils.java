...
public class AmkAUtils {
    ...
    public static BukkitTask createRegisterReminder(Player p, Plugin pl) {
		...
		if(Config.sessionType.contains("HiddenChat"))
	        return createReminder(p, pl, ChatColor.RED + colorize(Language.PLEASE_REGISTER_WITH0.toString()) + ":" + ChatColor.GRAY + " t\\register [" + RegType + "]" + ChatColor.RED + "!", Config.remindInterval * 20L);
		else
			return createReminder(p, pl, ChatColor.RED + colorize(Language.PLEASE_REGISTER_WITH1.toString()) + ":" + ChatColor.GRAY + " /register [" + RegType + "]" + ChatColor.RED + "!", Config.remindInterval * 20L);
    }
    ...
    public static BukkitTask createLoginReminder(Player p, Plugin pl) {
		...
		if(Config.sessionType.contains("HiddenChat"))
	        return createReminder(p, pl, ChatColor.RED + colorize(Language.PLEASE_LOG_IN_WITH0.toString()) + ":" + ChatColor.GRAY + " t\\login [" + RegType + "]" + ChatColor.RED + "!", Config.remindInterval * 20L);
		else
			return createReminder(p, pl, ChatColor.RED + colorize(Language.PLEASE_LOG_IN_WITH1.toString()) + ":" + ChatColor.GRAY + " /login [" + RegType + "]" + ChatColor.RED + "!", Config.remindInterval * 20L);
    }
